<template>
  <div class="w-full relative flex flex-col justify-between">
    ...
    >
      ...
      <div class="relative">
        ...
        <input
          ...
          ref="search"
          v-model="q"
          class="block w-full pl-10 pr-3 py-2 truncate leading-5 placeholder-gray-500 border border-transparent text-gray-600 focus:text-gray-700 focus:border-gray-400 rounded-md focus:outline-none focus:bg-gray-300 bg-gray-200"
    ...
    <ul
      ...
      class="z-10 absolute w-full flex-1 top-0 bg-gray-100 text-gray-700 rounded-md border border-gray-700 overflow-hidden"
    ...
    >
      ...
      >
        <NuxtLink
          ...
          :class="{
            'text-primary-500 bg-gray-200': focusIndex === index
          }"
          @click="focus = false"
        >
